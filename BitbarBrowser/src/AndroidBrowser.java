...
public class AndroidBrowser {
	...
	public static String screenshot_path = "/home/netstorm/Desktop/Screenshots/Chrome";
	public static void main(String[] args) throws Exception {
		...
		capas.setCapability("testdroid_target", "chrome");
		capas.setCapability("testdroid_project", "Chrome Browser");
		capas.setCapability("testdroid_testrun", "chrome 1");
		capas.setCapability("testdroid_device", "Asus Google Nexus 7 (2013) ME571KL");
		capas.setCapability("platformName", "android");
		capas.setCapability("deviceName", "AndroidDevice");
		capas.setCapability("browserName", "chrome");
